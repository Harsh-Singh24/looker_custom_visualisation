...
const pivotMeasures = measures.filter(m=>!m.is_table_calculation)
const tableCalcs = measures.filter(m=>m.is_table_calculation)
...
const numeric = headers[i].type==="measure"
? "numeric"
: ""
