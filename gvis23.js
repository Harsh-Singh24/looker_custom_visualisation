looker.plugins.visualizations.add({
  ...
  create: function(element) {
    element.innerHTML = 
      ...
      '  table { border-collapse: collapse; width: 100%; table-layout: auto; font-family: \'Open Sans\', Arial, sans-serif; font-size: 10px; }' +
      ...
      '  .view-name { font-size: 10px; color: #939ba5 !important; font-weight: 400; display: block; margin-bottom: 2px; text-decoration: none !important; }' +
      '  .field-name { font-size: 10px; color: #262d33 !important; font-weight: 600; display: block; text-decoration: none !important; }' +
      ...
      '  .is-printing table { font-size: 10px !important; }' +
