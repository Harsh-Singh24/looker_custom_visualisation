looker.plugins.visualizations.add({
  ...
  create: function(element) {
    element.innerHTML = `
      <style>
        ...
        /* STICKY HEADER RESTRUCTURED FOR MULTI-ROW SUPPORT */
  ...
  updateAsync: function(data, element, config, queryResponse, details, done) {
    ...
    function render() {
      ...
      // --- DYNAMIC SEPARATE MULTI-TIER HEADER GRID ENGINE ---
      ...
      for (var r = 0; r < maxHeaderRows; r++) {
        headerGrid.push(new Array(headers.length).fill(null));
      }
      ...
      headers.forEach(function(h, i) {
        ...
        if (!h.pivot) {
          // Standard Dimension or Non-pivoted Calc (Full Grid Height Spanning)
          let headerText = "";
          ...
          // Pivoted Columns (Split Values Separately into Upper Rows)
